...
async function cargarConfiguracion() {
    ...
    try {
        ...
        CONFIG = normalizeConfig({
            ...
            grupo: 'TIC 026, TIC 026 y TIC 026',
            ...
            fecha_examen: 'TIC 026: Sábado 27 de 13:00 a 14:00 hs. | TIC 026: Sábado 27 de 20:30 a 21:30 hs. | TIC 026: Sábado 27 de 20:30 a 21:30 hs.',
...
function reemplazarPlaceholders() {
    ...
    if (headerMateria) headerMateria.textContent = CONFIG.materia || 'TIC General';
...
function generarActa(cedula) {
    ...
    <div class="acta">
        ...
        <div class="subtitle">Acta de Examen — ${CONFIG.materia || 'TIC'}</div>
